#!/bin/bash
# ============================================================
#  ClawHub Release Script - goverment-bidding-email
#  用途：将项目发布到 ClawHub（release 分支）
# ============================================================
set -euo pipefail
...
release_project() {
  echo ""
  echo -e "${BLUE}════════════════════════════════════════${NC}"
  info "开始发布: goverment-bidding-email"
  echo -e "${BLUE}════════════════════════════════════════${NC}"
...
echo -e "${GREEN}══════════════════════════════════════════${NC}"
echo ""
echo "ClawHub 后台刷新 release 分支后即可看到更新。"
